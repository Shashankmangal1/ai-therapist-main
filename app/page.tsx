    ...
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <section className="relative min-h-[90vh] mt-20 flex flex-col items-center justify-center py-12 px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-plus-jakarta tracking-tight">
            <span className="inline-block bg-gradient-to-r from-primary via-primary/90 to-secondary bg-clip-text text-transparent [text-shadow:0_1px_0_rgb(0_0_0/20%)] hover:to-primary transition-all duration-300">
              Find Peace
            </span>
            <br />
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <MotionDiv className="text-center mb-16 space-y-4 text-white ">
